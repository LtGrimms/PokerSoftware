...
function parsePlayersHoleCards(data, endOfActionIndex, showDown) {
    var holeCards = [];  
    var yourHoleCards = {};
...
function parsePlayersInformation(lines, endOfPlayerIndex, endOfActionIndex, handNumber, showDown) {
    ...
    if (!showDown) {
        for (var line = endOfActionIndex; i < lines.length; i++) {
...
function parse_hand(data) {
    ...
    //Parse The Board
    var board = parseBoardTable(data, hand.handNumber);
    //console.log(board);

    //Parse Players Hole Cards
    var holeCards = parsePlayersHoleCards(data, endOfActionIndex, handEndedInShowDown);

    //Parse Players' Information    
    var seats = parsePlayersInformation(lines, endOfPlayerIndex, endOfActionIndex, hand,handNumber, handEndedInShowDown);

    //Parse Actions
    var actions = parseActions(lines, endOfPlayerIndex, endOfActionIndex, hand.handNumber, hand.bigBlindAmount);
